...
\033[31m#######################################################\033[m
                Let's Tweak Kali
          Bunch of tweak to make Kali faster 
\033[31m#######################################################\033[m"
select menusel in "Tweak my Kali plzplzplz" "Back to Main"; do
case $menusel in
        "Tweak my Kali plzplzplz")
                
		echo -e "\033[31m====== Tweakalicing ======\033[m"
		apt-get update
		apt-get install -y aria2 axel
		alias wget="axel -n 5"
		alias curl="axel -n 5"
...
case $menusel in
	...
	"Install All")
		...
		installLazagne
		installsparta
		echo -e "\e[32m[-] Done Installing hacking tools\e[0m"
		pause
		extras ;;
...
|                 Password:           [  ***********  ]                        |
|                                                                              |
|                My facebook: www.facebook.com/darkspellx                      |
|                                                                              |  
|  This script will configure your system, add tools and fix general issues    |                                                                      
|                                                                              |
|                                   [ OK ]                                     |
|______________________________________________________________________________|
\033[m                                        
...
select menusel in "Update Kali" "Personal tweaks" "Software and System Tools" "Install Hacking Tools" "Update tools to latest version" "EXIT PROGRAM"; do
case $menusel in
	"Update Kali")
		updatekali
		clear ;;
...
=======
	...
	"Must View")
		...
		pause
		clear ;;
>>>>>>> 1a95a192eb4eb411d573442f235d16c3f004ffc3
